...
public static class DateTimeExtensions
{
    ...
    public static DateTime MonthStart(this DateTime monthMoment) =>
        Date.MonthStart(monthMoment.Year, monthMoment.Month);
    ...
    public static DateTime DayStart(this DateTime dayMoment) =>
        Date.DayStart(dayMoment.Year, dayMoment.Month, dayMoment.Day);
    ...
    public static int GetIso8601WeekOfYear(this DateTime test) =>
    ...
    /// <returns>ISO 8601 week number</returns>
    public static int GetIso8601WeekOfYear(this DateTime test, CultureInfo culture)
    {
        System.DayOfWeek day = culture.Calendar.GetDayOfWeek(test);
        if (day >= System.DayOfWeek.Monday && day <= System.DayOfWeek.Wednesday)
        {
            test = test.AddDays(3);
        }
        return culture.Calendar.GetWeekOfYear(
            test, System.Globalization.CalendarWeekRule.FirstFourDayWeek, System.DayOfWeek.Monday);
    }
    ...
    public static DateTime GetPreviousWeekDay(this DateTime date, System.DayOfWeek dayOfWeek)
    {
    ...
    public static DateTime GetNextWeekDay(this DateTime date, System.DayOfWeek dayOfWeek)
    {
        while (date.DayOfWeek != dayOfWeek)
        {
            date = date.AddDays(1);
    ...
    public static bool IsDayOfWeek(this DateTime date, IEnumerable<System.DayOfWeek> days) =>
...
public static class DatePeriodExtensions
{
    ...
    public static bool IsStartDayOfWeek(this DatePeriod period, System.DayOfWeek testDay) =>
    ...
    public static bool IsStartMonday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Monday);
    ...
    public static bool IsStartTuesday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Tuesday);
    ...
    public static bool IsStartWednesday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Wednesday);
    ...
    public static bool IsStartThursday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Thursday);
    ...
    public static bool IsStartFriday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Friday);
    ...
    public static bool IsStartSaturday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Saturday);
    ...
    public static bool IsStartSunday(this DatePeriod period) =>
        IsStartDayOfWeek(period, System.DayOfWeek.Sunday);
    ...
    public static bool IsEndDayOfWeek(this DatePeriod period, System.DayOfWeek testDay) =>
    ...
    public static bool IsEndMonday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Monday);
    ...
    public static bool IsEndTuesday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Tuesday);
    ...
    public static bool IsEndWednesday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Wednesday);
    ...
    public static bool IsEndThursday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Thursday);
    ...
    public static bool IsEndFriday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Friday);
    ...
    public static bool IsEndSaturday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Saturday);
    ...
    public static bool IsEndSunday(this DatePeriod period) =>
        IsEndDayOfWeek(period, System.DayOfWeek.Sunday);

    /// <summary>Calculate the count of working days</summary>
    /// <param name="period">The period</param>
    /// <param name="days">Available days</param>
    /// <returns>The number of working days</returns>
    public static int GetWorkingDaysCount(this DatePeriod period, IEnumerable<System.DayOfWeek> days)
    {
        var dayCount = 0;
...
public static class CaseValueExtensions
{
    ...
    public static IEnumerable<CaseValue> WhereStart(this IEnumerable<CaseValue> periodValues,
        params System.DayOfWeek[] weekdays) =>
